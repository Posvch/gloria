...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			{key: key, url: url, x: flags.x, y: flags.y},
			$elm$core$Platform$Cmd$none);
	});
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Messages$DeviceResized = F2(
	function (a, b) {
		return {$: 'DeviceResized', a: a, b: b};
	});
	...
	return $elm$browser$Browser$Events$onResize(
		F2(
			function (width, height) {
				return A2($author$project$Messages$DeviceResized, width, height);
			}));
};
	...
	A2(
		...
		_List_fromArray(
			[
				...
				A2($mdgriffith$elm_ui$Element$spacingXY, 36, 18),
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('GLORIA '),
								$mdgriffith$elm_ui$Element$text('ЮРИДИЧЕСКИЕ КОНСУЛЬТАЦИИ В ТЮМЕНИ')
							])),
						A2(
						$mdgriffith$elm_ui$Element$paragraph,
						_List_Nil,
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('Адрес: г. Тюмень, ул. Монтажников 61, офис 28')
							]))
					])),
				A2(
				$mdgriffith$elm_ui$Element$wrappedRow,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('Email: something@mail.mail')
							])),
						A2(
						$mdgriffith$elm_ui$Element$wrappedRow,
						_List_Nil,
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('Номер телефона:'),
								$mdgriffith$elm_ui$Element$text('8-800-555-35-35')
							])),
						A2(
						$mdgriffith$elm_ui$Element$paragraph,
						_List_Nil,
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('Социальные сети: vk')
							]))
					]))
			])));
...
var $author$project$View$roundButton = A2(
	$mdgriffith$elm_ui$Element$Input$button,
	_List_fromArray(
		[
			A2($mdgriffith$elm_ui$Element$paddingXY, 36, 18),
			$mdgriffith$elm_ui$Element$Background$color(
			A3($mdgriffith$elm_ui$Element$rgb, 0.85, 0.85, 0.9)),
		...
		label: A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Font$typeface('Gilroy')
						])),
					$mdgriffith$elm_ui$Element$Font$letterSpacing(1)
				]),
			$mdgriffith$elm_ui$Element$text('Кнопка⟶')),
...
var $author$project$View$lead = function (h) {
	return A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$Background$image('/static/img/stock.jpg'),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.')
									])),
								A2(
								$mdgriffith$elm_ui$Element$column,
								_List_fromArray(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$text('- Lorem ipsum dolor sit amet')
											])),
										A2(
										$mdgriffith$elm_ui$Element$paragraph,
										_List_Nil,
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$text('- Lorem ipsum dolor sit')
											])),
										A2(
										$mdgriffith$elm_ui$Element$paragraph,
										_List_Nil,
								...
								$author$project$View$roundButton)
							]))
					])),
				A2(
				$mdgriffith$elm_ui$Element$row,
...
var $author$project$View$navLink = function (labelText) {
	return A2(
		...
		_List_Nil,
		{
			label: A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$moveDown(7),
						$mdgriffith$elm_ui$Element$Font$size(18),
						$mdgriffith$elm_ui$Element$Font$family(
						_List_fromArray(
							[
...
var $author$project$View$navbar = A2(
	...
	_List_fromArray(
		[
				...
				[
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$Font$light,
							$mdgriffith$elm_ui$Element$Font$letterSpacing(18)
						]),
					$mdgriffith$elm_ui$Element$text('GLORIA')),
					A2(
					$mdgriffith$elm_ui$Element$el,
					...
					A2(
						...
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Element$paddingXY, 8, 5)
							]),
						$mdgriffith$elm_ui$Element$text('Юридическая компания'))),
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
						[
			...
			{description: 'logo', src: '/static/img/gera_140.webp'})
		]));
						...
						A2(
							...
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
									$mdgriffith$elm_ui$Element$Background$color(
									A3($mdgriffith$elm_ui$Element$rgb, 0.94, 0.94, 0.95))
								]),
							$mdgriffith$elm_ui$Element$none))
					]),
				A2(
					...
					_List_fromArray(
						[
							...
							$author$project$View$lead(model.y - 307),
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{init: $author$project$Main$init, onUrlChange: $author$project$Messages$UrlChanged, onUrlRequest: $author$project$Messages$LinkClicked, subscriptions: $author$project$Main$subscriptions, update: $author$project$Update$update, view: $author$project$View$view});
